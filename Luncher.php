<?php
define('BOT_TOKEN', '239767461:AAFIf9UHRmhJg0pw81zFujxDdI-bY8GBDUc');
...
Get Out Of Here Idiot🖕" ,"parse_mode" =>"HTML"));	
	...
	apiRequest("sendMessage", array('chat_id' => $chat_id, "text" => " ,"parse_mode" =>"HTML"));
    ...
    apiRequest("sendphoto", array('chat_id' => $membersidd[$y], "photo" => $substtr,"caption" =>$caption));
		...
		$memcout = count($membersidd)-1;
	 	apiRequest("sendMessage", array('chat_id' => $chat_id, "text" => ".$memcout.","parse_mode" =>"HTML",'reply_markup' => array(
...
if($chat_id==$admin){
  apiRequestJson("sendMessage", array('chat_id' => $chat_id, "text" =>  Help️ ',"parse_mode"=>"MARKDOWN", 'reply_markup' => array(
        'keyboard' => array(array('🗣 Send To All'),array('⚓️ Help','👥 Members','❌ Blocked Users'),array("Settings ⚙")),
        'one_time_keyboard' => true,
        'selective' => true,
        'resize_keyboard' => true)));
...
-!-@-#-$"."
".$pmembersiddd[1]);
apiRequestJson("sendMessage", array('chat_id' => $chat_id, "text" => ".$starttext.""."
...
—------------------------------
🔸`3.`*Blocked Users*
All members black list
—-------------------------------
🔸`4.`*Settings*
* Developer * => @Dragon_Dev   @Dragon_DevRobot
...
.', 'reply_markup' => array(
        ...
        $pmembersid= explode("\n",$txxt);
    		...
    		apiRequestJson("sendMessage", array('chat_id' => $chat_id,"parse_mode"=>"HTML", "text" => 'reply_markup' => array(
        'keyboard' => array(array('🗣 Send To All'),array('⚓️ Help','👥 Members','❌ Blocked Users'),array("Settings ⚙")),
        'one_time_keyboard' => true,
        'selective' => true,
        'resize_keyboard' => true)));
...
.', 'reply_markup' => array(
    ...
    $texttoall =$text;
		...
		$mmemcount = count($membersidd) -1;
		 apiRequestJson("sendMessage", array('chat_id' => $chat_id,"parse_mode" =>"HTML", "text" =>  ".$mmemcount,'reply_markup' => array(
        'keyboard' => array(array('🗣 Send To All'),array('⚓️ Help','👥 Members','❌ Blocked Users'),array("Settings ⚙")),
        'one_time_keyboard' => true,
        'selective' => true,
        'resize_keyboard' => true)));
